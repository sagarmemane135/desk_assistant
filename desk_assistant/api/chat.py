...
When you mention a document name from tools, always write it as a markdown link using that row's desk_path, even in a one-sentence answer: [ACC-SINV-2026-00004](/app/sales-invoice/ACC-SINV-2026-00004). Never leave a bare ID.
